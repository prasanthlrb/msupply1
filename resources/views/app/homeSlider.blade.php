      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
                <button id="open_model" data-backdrop="false" class="btn btn-success round btn-glow px-2" data-toggle="modal">Create Home Slider</button>
          </div>
            ...
            <div class="card-body card-dashboard">
              <table class="table table-striped table-bordered zero-configuration">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$row->id}}</td>
                    <td><img style="width: 100px;" src="{{asset('home_slider/').'/'.$row->slider_image}}" alt=""></td>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary white">
          <h4 class="modal-title white" id="myModalLabel8">Create Home Slider Image</h4>
        ...
        <div class="modal-body">
          <div class="form-group row">
            <label class="col-md-3 label-control" for="projectinput1">Home Slider Image</label>
            <div class="col-md-9">
...
<script>
  ...
  $('#open_model').click(function(){
    ...
    action_type = 1;
    $('#saveCat').text('Save');
    $('#myModalLabel8').text('Create Slider Home');
  })
    function saveBrand(){
        ...
        $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $("#brand_form")[0].reset();
                     ...
                     toastr.success('Home Slider ', 'Successfully Save');
                },error: function (data) {
                    console.log(data)
          ...
          success: function(data)
          {
            console.log(data);
              $("#brand_form")[0].reset();
               $('#brand_model').modal('hide');
               $('.zero-configuration').load(location.href+' .zero-configuration');
               toastr.success('Home Slider Update Successfully', 'Successfully Update');
          },error: function (data) {
            toastr.error('Image File', 'Required!');
        }
      });
    ...
    function editCat(id){
      ...
      $.ajax({
        ...
        success: function(data)
        {
          ...
          '<img src="/home_slider/'+data.slider_image+'" width="100px"></div><br>';
          $('#brand_image_place').html(slider_image);
          }
          $('#myModalLabel8').text('Update Home Slider Image');
     ...
     function deleteCat(id){
      ...
      if (r == true) {
      $.ajax({
        url : '/admin/delete_home-slider/'+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
          toastr.success('Home Slider Delete Successfully', 'Successfully Delete');
          $('.zero-configuration').load(location.href+' .zero-configuration');
        }
      });
    }
